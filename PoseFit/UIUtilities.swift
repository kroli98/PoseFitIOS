...
public class UIUtilities {
    ...
    public static func createPoseOverlayView(
        forPose pose: Pose, inViewWithBounds bounds: CGRect, lineWidth: CGFloat, dotRadius: CGFloat, treshold: Float,
      ...
      for (startLandmarkType, endLandmarkTypesArray) in UIUtilities.poseConnections() {
        ...
        for endLandmarkType in endLandmarkTypesArray {
          ...
          let endColor = UIUtilities.interpolatedColor(
            ...
            if(startLandmark.inFrameLikelihood > treshold 
               && endLandmark.inFrameLikelihood > treshold)
            {
      ...
      for landmark in pose.landmarks {
          if(landmark.inFrameLikelihood > treshold)
          {
